			...
			<div className='text-center space-y-8 px-4'>
				...
				<div className='flex flex-col sm:flex-row gap-4 justify-center items-center mt-8'>
					<Button
						onClick={() => navigate(-1)}
						variant='outline'
						className='bg-neutral-800 text-white w-full sm:w-auto'
					>
						Go Back
					</Button>
					<Button
						onClick={() => navigate("/")}
						className='bg-linear-to-r from-purple-500 via-pink-500 to-teal-400 hover:from-purple-600 hover:via-pink-600 hover:to-teal-500 text-white w-full sm:w-auto'
					>
